...
const PortfolioSingleItem2= ({id, title, description, images, usedStacks, projectURL, githubURL }) => {
        ...
        <div className="row project-card" data-toggle="modal" data-target={`#portfolioModal${id}`} data-portfolio-tag="web-sites">
            ...
            <div className="modal-dialog modal-lg" role="document">
                ...
                <div className="modal-body col-md-11 col-lg-9 ml-auto mr-auto">
                    ...
                    <button onClick={()=>window.open(`${projectURL }`, '_blank') } className="btn btn-primary portfolio-modal__link-right"> Paper</button>
...
export default PortfolioSingleItem2;